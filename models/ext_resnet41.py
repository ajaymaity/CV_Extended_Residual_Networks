...
def createNetwork(imgShape, classes, learningRate=0.1):
    """ Copied ResNet50 network from GitHub -> https://github.com/keras-team/keras/blob/master/keras/applications/resnet50.py, and edited.
    Create an ExtResNet-41 network.
        Args:
        ...
        Returns:
            the compiled ExtResNet-41 model.
    """
    ...
    x3 = AveragePooling2D((2, 2), name="avg_pool")(x3)

    x3 = Flatten(name="flatten")(x3)
    x3 = Dense(classes, activation="softmax", name="predictions")(x3)

    model = models.Model(img_input, x3, name="ext-resnet41")
